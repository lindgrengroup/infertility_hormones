...
OUTPUTDIR<-paste("/well/lindgren/laura/projects/infertility/plots/qq_study_level",STUDY,sep="/")
...
# Output QCed data
setwd(OUTPUTDIR)
OUTPUT_FILENAME<-paste(STUDY,paste(TRAIT,"X_XYchrom_QCed.txt",sep="_"),sep="_")
