...
#SBATCH -J EstBB_QC_noMAC

#SBATCH --output /well/lindgren/laura/projects/infertility/easyQC/logs/EstBB_QC_noMAC-%j.out 

#SBATCH --error /well/lindgren/laura/projects/infertility/easyQC/logs/EstBB_QC_noMAC-%j.err 
#SBATCH -p short 
...
while IFS=$'\t' read -r STUDY TRAIT INPUT_FILE N_CASES N_CONTROLS	
	...
	done < /well/lindgren/laura/projects/infertility/easyQC/EstBB_QC_inputfile.txt
