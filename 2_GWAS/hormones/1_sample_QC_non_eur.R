...
STRATA <- c("Oestradiol_AFR_F", "Oestradiol_AFR_sex_comb",
            "Oestradiol_SAS_F", "Oestradiol_SAS_sex_comb",
            "Testosterone_AFR_F", "Testosterone_AFR_M", "Testosterone_AFR_sex_comb",
            "Testosterone_EAS_F", "Testosterone_EAS_sex_comb",
            "Testosterone_SAS_F", "Testosterone_SAS_M", "Testosterone_SAS_sex_comb")
...
write.table(to_write_sample_file, 
            paste0("/well/lindgren-ukbb/projects/ukbb-11867/samvida/hormone_ehr/GWAS/sample_qc/qcd_non_eur_sample_file_for_regenie.txt"), 
