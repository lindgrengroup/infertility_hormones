...
#SBATCH -J coloc_fi4_eur

#SBATCH --output /well/lindgren/laura/projects/infertility/colocalisations/GTEx_eQTL/logs/coloc_fi4_eur-%j.out 

#SBATCH --error /well/lindgren/laura/projects/infertility/colocalisations/GTEx_eQTL/logs/coloc_fi4_eur-%j.err 
#SBATCH -p short 
...
TRAIT="female_infertility_analysis4_eur"
