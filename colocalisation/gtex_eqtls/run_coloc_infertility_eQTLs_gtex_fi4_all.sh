...
#SBATCH -J coloc_fi4_all

#SBATCH --output /well/lindgren/laura/projects/infertility/colocalisations/GTEx_eQTL/logs/coloc_fi4_all-%j.out 

#SBATCH --error /well/lindgren/laura/projects/infertility/colocalisations/GTEx_eQTL/logs/coloc_fi4_all-%j.err 
#SBATCH -p short 
...
TRAIT="female_infertility_analysis4_all"
