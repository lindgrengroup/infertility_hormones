...
#SBATCH -J coloc_fi2_eur

#SBATCH --output /well/lindgren/laura/projects/infertility/colocalisations/GTEx_eQTL/logs/coloc_fi2_eur-%j.out 

#SBATCH --error /well/lindgren/laura/projects/infertility/colocalisations/GTEx_eQTL/logs/coloc_fi2_eur-%j.err 
#SBATCH -p short 
...
TRAIT="female_infertility_analysis2_eur"
