...
#SBATCH -J coloc_fi5_all

#SBATCH --output /well/lindgren/laura/projects/infertility/colocalisations/GTEx_eQTL/logs/coloc_fi5_all-%j.out 

#SBATCH --error /well/lindgren/laura/projects/infertility/colocalisations/GTEx_eQTL/logs/coloc_fi5_all-%j.err 
#SBATCH -p short 
...
TRAIT="female_infertility_analysis5_all"
